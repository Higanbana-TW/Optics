  ...
  <body>
        ...
        <section class="converter-layout" aria-label="MIPI RAW10 轉換器">
          <aside class="control-panel">
            ...
            <div class="panel-actions">
              ...
              <p class="hint">用 Chrome 或 Edge 開啟這個網頁即可。這不是執行 .js 或 .exe，轉換在瀏覽器裡完成，檔案不會上傳。</p>
            </div>
          </aside>
    ...
    <dialog id="helpDialog">
      <div class="dialog-content help-content">
        ...
        <h2>使用方式</h2>
        <dl>
          <div><dt>機構電腦</dt><dd>用瀏覽器開啟網址即可，不必執行 .js / .exe / Python</dd></div>
          <div><dt>1</dt><dd>拖入 .raw，或按「載入示範畫面」</dd></div>
          <div><dt>2</dt><dd>確認寬高與 Bayer 後，下載 PNG / JPG / BMP</dd></div>
        </dl>
      </div>
    </dialog>
    <script>
